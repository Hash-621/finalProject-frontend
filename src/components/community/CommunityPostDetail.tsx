                ...
                <div className="flex items-center gap-3">
                  ...
                  <div
                    className={`flex items-center justify-center font-bold text-sm shadow-md rounded-2xl ${
                      isReply
                        ? "w-8 h-8 bg-white text-slate-600 border border-slate-200" // 대댓글 프로필
                        : `w-11 h-11 text-white ${styles.profileBg} ${styles.profileShadow}` // 원래 프로필
                    }`}
                  >
              ...
              <p
                className={`whitespace-pre-wrap leading-relaxed ${
                  comment.isDelete
                    ...
                    : `font-medium ${
                        isReply
                          ? "text-slate-600 text-[14px] pl-1" // 대댓글 텍스트
                          : "text-slate-800 text-[16px] pl-1" // 원래 댓글 텍스트
                      }`
                }`}
              >
